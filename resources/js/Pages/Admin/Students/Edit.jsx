...
import { FaArrowLeft, FaUserEdit, FaIdCard, FaEnvelope, FaGraduationCap } from "react-icons/fa"
                        ...
                        <div className="p-4 sm:p-6">
                            ...
                            <div className="mb-6 rounded-lg bg-green-50 p-4 border-l-4 border-green-500">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-3">
                                        <h2 className="text-sm font-medium text-green-800">Editing Student Record</h2>
