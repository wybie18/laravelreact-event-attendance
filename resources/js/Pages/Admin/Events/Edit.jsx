...
import { FaArrowLeft, FaCalendarCheck, FaCalendarAlt, FaClock } from "react-icons/fa"
import { FiInfo, FiCalendar, FiClock, FiPlus, FiTrash2 } from "react-icons/fi"
import toast from "react-hot-toast"
import { useState } from "react"

export default function Edit({ event, semesters, timeSlotTypes }) {
                        ...
                        <div className="p-4 sm:p-6">
                            ...
                            <div className="mb-6 rounded-lg bg-green-50 p-4 border-l-4 border-green-500">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-3">
                                        <h2 className="text-sm font-medium text-green-800">Editing Event</h2>
                                        <p className="mt-1 text-sm text-green-700">
                                            You are editing <strong>{event.name}</strong>. Fields marked with an asterisk (*) are required.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form onSubmit={onSubmit} className="space-y-8">
                                ...
                                <div className="flex flex-col-reverse sm:flex-row sm:justify-end pt-6 gap-3 border-t border-gray-200">
                                    ...
                                    >
                                        ...
                                        {processing || isSubmitting ? "Updating..." : "Update Event"}
                                    </button>
                                </div>
                            </form>
                        </div>
